    ...
    query: {
      ...
      qa: [
        ...
        },
        {
          ...
          answer: 'മണ്ണിലെ കാർബണിക് അംശം വർധിപ്പിക്കുക, മണ്ണ് പരിശോധനയെ അടിസ്ഥാനമാക്കി സമതുലിത പോഷണം നൽകുക, സമയബന്ധിതമായി ജലസേചനം ചെയ്യുക, കീടങ്ങൾക്ക് IPM സ്വീകരിക്കുക, ഗുണമേന്മയുള്ള വിത്തും ശരിയായ ഇടവേളയും ഉറപ്പാക്കുക, വിളപ്പൊരുക്ക്/ഇന്റർ-ക്രോപ്പിംഗ് ചെയ്യുക.'
        },
        {
